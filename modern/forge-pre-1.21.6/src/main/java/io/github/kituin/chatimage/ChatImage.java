...
public final class ChatImage {
    ...
    @Mod.EventBusSubscriber(modid="chatimage",value=net.minecraftforge.api.distmarker.Dist.CLIENT,bus=Mod.EventBusSubscriber.Bus.MOD)
    ...
    @Mod.EventBusSubscriber(modid="chatimage",value=net.minecraftforge.api.distmarker.Dist.CLIENT,bus=Mod.EventBusSubscriber.Bus.FORGE)
