...
public class ChatImage implements ModInitializer {
    ...
    public void onInitialize() {
       ...
       ServerPlayNetworking.registerGlobalReceiver(FileChannelPacket.ID, (packet, context) -> ChatImagePacket.serverFileChannelReceived(packet, context.player()));
       ServerPlayNetworking.registerGlobalReceiver(FileInfoChannelPacket.ID, (packet, context) -> ChatImagePacket.serverGetFileChannelReceived(packet, context.player()));
    }
}
